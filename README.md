...
_Last refreshed: 2026-08-16 15:33 UTC_
...
| [`polar-hosts`](https://github.com/networkextension/polar-hosts) | 2026-08-16 · [`d066a32`](https://github.com/networkextension/polar-hosts/commit/d066a32) feat(internal): DELETE /internal/v1/hosts/:id — retire a guest host (kick conn, delete row, revoke local agent tokens); loopback-only (#39) | 0 |
