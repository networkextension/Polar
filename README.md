...
_Last refreshed: 2026-08-17 07:59 UTC_
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-08-16 · [`533c2a0`](https://github.com/networkextension/polar-agent/commit/533c2a0) feat(cloud.vm): pass seed_label + ready_regex to polar-vmd; cloud.guest LookPath systemctl (#28) | [1 open](https://github.com/networkextension/polar-agent/pulls) |
...
| [`polar-wg`](https://github.com/networkextension/polar-wg) | 2026-08-16 · [`7626dd3`](https://github.com/networkextension/polar-wg/commit/7626dd3) feat(internal): loopback token lifecycle for sibling plugins (polar-cloud VM enrolment) (#45) | 0 |
| [`polar-hosts`](https://github.com/networkextension/polar-hosts) | 2026-08-16 · [`d066a32`](https://github.com/networkextension/polar-hosts/commit/d066a32) feat(internal): DELETE /internal/v1/hosts/:id — retire a guest host (kick conn, delete row, revoke local agent tokens); loopback-only (#39) | [1 open](https://github.com/networkextension/polar-hosts/pulls) |
