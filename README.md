...
_Last refreshed: 2026-06-18 02:16 UTC_

| Repo | Last commit | Open PRs |
|---|---|---|
| [`polar-sdk`](https://github.com/networkextension/polar-sdk) | 2026-06-07 · [`d553049`](https://github.com/networkextension/polar-sdk/commit/d553049) feat(assets): workspace-scoped asset download URLs (#18) | 0 |
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-06-15 · [`227f04f`](https://github.com/networkextension/polar-agent/commit/227f04f) feat(agent): consume per-agent LLM proxy token from register (P2 agent-side) (#22) | 0 |
| [`polar-dock-ui`](https://github.com/networkextension/polar-dock-ui) | 2026-06-15 · [`1d566b3`](https://github.com/networkextension/polar-dock-ui/commit/1d566b3) Merge pull request #38 from networkextension/docs/auth-refresh | 0 |
| [`polar-dock`](https://github.com/networkextension/polar-dock) | 2026-06-15 · [`21b2a5a`](https://github.com/networkextension/polar-dock/commit/21b2a5a) feat(dock): GET /api/auth/methods — login UI hint for federated login (#450) | 0 |
...
| [`polar-release`](https://github.com/networkextension/polar-release) | 2026-06-14 · [`ac0c42e`](https://github.com/networkextension/polar-release/commit/ac0c42e) Merge pull request #1 from networkextension/feat/promotion-gate | 0 |
| [`polar-wg`](https://github.com/networkextension/polar-wg) | 2026-06-15 · [`b98809d`](https://github.com/networkextension/polar-wg/commit/b98809d) feat(wg): operator-published cross-hub routes (manual link, no auto full-mesh) (#33) | [1 open](https://github.com/networkextension/polar-wg/pulls) |
| [`polar-hosts`](https://github.com/networkextension/polar-hosts) | 2026-06-11 · [`3740ec3`](https://github.com/networkextension/polar-hosts/commit/3740ec3) Merge pull request #29 from networkextension/feat/hosts-phase-4c | 0 |
...
| [`polar-music`](https://github.com/networkextension/polar-music) | 2026-06-16 · [`4cf221d`](https://github.com/networkextension/polar-music/commit/4cf221d) fix(player): progress bar stuck on FLAC/Safari — fall back to metadata duration (#13) | 0 |
| [`polar-dns`](https://github.com/networkextension/polar-dns) | 2026-06-07 · [`f500312`](https://github.com/networkextension/polar-dns/commit/f500312) Add MIT License | 0 |
| [`polar-packtunnel`](https://github.com/networkextension/polar-packtunnel) | 2026-05-27 · [`71f6069`](https://github.com/networkextension/polar-packtunnel/commit/71f6069) chore(deps): bump polar-sdk v0.2.0 → v0.2.1 (#2) | 0 |
| [`polar-iosdist`](https://github.com/networkextension/polar-iosdist) | 2026-06-15 · [`aa90944`](https://github.com/networkextension/polar-iosdist/commit/aa90944) refactor(iosdist): read-side cutover to assets-only (#10) | 0 |
| [`polar-photo`](https://github.com/networkextension/polar-photo) | 2026-06-14 · [`6304bab`](https://github.com/networkextension/polar-photo/commit/6304bab) Merge pull request #17 from networkextension/fix/grid-image-thumb-fallback | 0 |
| [`polar-survey`](https://github.com/networkextension/polar-survey) | 2026-06-16 · [`458e7d8`](https://github.com/networkextension/polar-survey/commit/458e7d8) chore: deploy artifacts — survey.opera.daotian.ai (:8102) | 0 |
| [`polar-buildings`](https://github.com/networkextension/polar-buildings) | 2026-06-04 · [`9532eaa`](https://github.com/networkextension/polar-buildings/commit/9532eaa) Merge pull request #5 from networkextension/feat/timeseries-smc-p0 | 0 |
| [`polar-lawyer`](https://github.com/networkextension/polar-lawyer) | 2026-06-15 · [`79ba147`](https://github.com/networkextension/polar-lawyer/commit/79ba147) Merge pull request #3 from networkextension/feat/rag-adopt-dataflow | 0 |
| [`polar-screen`](https://github.com/networkextension/polar-screen) | 2026-06-09 · [`1618b12`](https://github.com/networkextension/polar-screen/commit/1618b12) Merge pull request #11 from networkextension/feat/m5-attribution-cpa | 0 |
| [`polar-film`](https://github.com/networkextension/polar-film) | 2026-06-14 · [`1f64ba7`](https://github.com/networkextension/polar-film/commit/1f64ba7) feat(filmscan): TMDB cast auto-naming for speaker clusters (P3) (#15) | 0 |
| [`polar-stock`](https://github.com/networkextension/polar-stock) | 2026-06-08 · [`ef8a747`](https://github.com/networkextension/polar-stock/commit/ef8a747) Merge pull request #4 from networkextension/fix/stock-embed-align | 0 |
| [`polar-dataflow`](https://github.com/networkextension/polar-dataflow) | 2026-06-15 · [`269ae9d`](https://github.com/networkextension/polar-dataflow/commit/269ae9d) Merge pull request #1 from networkextension/feat/rag-hybrid | 0 |
| [`polar-zone`](https://github.com/networkextension/polar-zone) | 2026-06-15 · [`f49498e`](https://github.com/networkextension/polar-zone/commit/f49498e) Merge pull request #11 from networkextension/feat/zone-discover-idp | 0 |
| [`polar-sdk-swift`](https://github.com/networkextension/polar-sdk-swift) | 2026-06-08 · [`697f1a7`](https://github.com/networkextension/polar-sdk-swift/commit/697f1a7) feat(cli): polar token — manage open-API tokens from the terminal (#10) | [1 open](https://github.com/networkextension/polar-sdk-swift/pulls) |
| [`polar-sdk-py`](https://github.com/networkextension/polar-sdk-py) | 2026-06-15 · [`d5925ac`](https://github.com/networkextension/polar-sdk-py/commit/d5925ac) Merge pull request #1 from networkextension/feat/llm-assets | 0 |
| [`ShangDynasty`](https://github.com/networkextension/ShangDynasty) | 2026-06-12 · [`437bcd9`](https://github.com/networkextension/ShangDynasty/commit/437bcd9) feat(app): multi-account/multi-endpoint + per-endpoint dynamic module tabs (#9) | 0 |
| [`polar-wg-app`](https://github.com/networkextension/polar-wg-app) | 2026-06-14 · [`7f96aa4`](https://github.com/networkextension/polar-wg-app/commit/7f96aa4) Merge pull request #27 from networkextension/feat/multi-hub-egress-client | 0 |
| [`Athens`](https://github.com/networkextension/Athens) | 2026-05-27 · [`4bcddf0`](https://github.com/networkextension/Athens/commit/4bcddf0) Merge pull request #4 from networkextension/release-script | 0 |
