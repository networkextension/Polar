...
_Last refreshed: 2026-08-18 05:43 UTC_
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-08-17 · [`5f9c161`](https://github.com/networkextension/polar-agent/commit/5f9c161) feat(bsd): OpenBSD/NetBSD guests — cloud.guest poweroff/reboot (shutdown -p), hostinfo collector (sysctl; hw.uuid / machdep.dmi.system-uuid / persisted nonce for the v4 machine uuid; df for disk), kdp skill stub on netbsd (no go.bug.st/serial port) (#30) | 0 |
