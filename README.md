...
_Last refreshed: 2026-08-16 03:11 UTC_
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-08-16 · [`587ea13`](https://github.com/networkextension/polar-agent/commit/587ea13) feat(compute): dock compute-tasks pull loop + cloud.vm (macOS worker → polar-vmd) + cloud.guest (in-VM poweroff) + resumable download (#27) | [1 open](https://github.com/networkextension/polar-agent/pulls) |
