...
_Last refreshed: 2026-05-27 11:00 UTC_
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-05-27 · [`7ecbd39`](https://github.com/networkextension/polar-agent/commit/7ecbd39) fix(hostinfo): use absolute paths for sysctl + system_profiler on darwin (#11) | 0 |
...
| [`polar-hosts`](https://github.com/networkextension/polar-hosts) | 2026-05-27 · [`2135073`](https://github.com/networkextension/polar-hosts/commit/2135073) feat: persist hello.host_info via new /internal/v1/hosts/hello endpoint (#9) | 0 |
