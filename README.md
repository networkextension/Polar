...
_Last refreshed: 2026-06-15 21:48 UTC_
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-06-09 · [`c274d47`](https://github.com/networkextension/polar-agent/commit/c274d47) feat(hostinfo): report IPv6 per iface, annotated private vs public (#21) | [1 open](https://github.com/networkextension/polar-agent/pulls) |
...
| [`polar-wg`](https://github.com/networkextension/polar-wg) | 2026-06-15 · [`8b1cb3d`](https://github.com/networkextension/polar-wg/commit/8b1cb3d) refactor(bundles): cutover to assets-only (drop local-disk fallback + backfill) (#32) | 0 |
