...
_Last refreshed: 2026-08-30 12:50 UTC_

| Repo | Last commit | Open PRs |
|---|---|---|
| [`polar-sdk`](https://github.com/networkextension/polar-sdk) | 2026-08-21 · [`f506dea`](https://github.com/networkextension/polar-sdk/commit/f506dea) feat(client): AgentGet — /internal/v1/agents/:id wrapper(agent 机器事实) (#26) | 0 |
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-08-23 · [`848a41a`](https://github.com/networkextension/polar-agent/commit/848a41a) Merge pull request #42 from networkextension/docs/freebsd-rcd | 0 |
...
| [`polar-assets`](https://github.com/networkextension/polar-assets) | 2026-08-27 · [`154f204`](https://github.com/networkextension/polar-assets/commit/154f204) Merge pull request #9 from networkextension/feat/blob-content-disposition | 0 |
| [`polar-release`](https://github.com/networkextension/polar-release) | _private — see repo_ | — |
| [`polar-wg`](https://github.com/networkextension/polar-wg) | 2026-08-29 · [`f74289d`](https://github.com/networkextension/polar-wg/commit/f74289d) Merge pull request #48 from networkextension/fix/install-script-no-python | [1 open](https://github.com/networkextension/polar-wg/pulls) |
| [`polar-hosts`](https://github.com/networkextension/polar-hosts) | 2026-08-17 · [`0f120e9`](https://github.com/networkextension/polar-hosts/commit/0f120e9) feat(internal): hosts/lookup returns host_info os_version/os_build/os_release_type (macOS guest placement) (#40) | 0 |
| [`polar-projects`](https://github.com/networkextension/polar-projects) | 2026-07-27 · [`f59801b`](https://github.com/networkextension/polar-projects/commit/f59801b) fix(ui): 项目详情页窄视口横向裁切 + 行内控件高度错位 (#7) | [1 open](https://github.com/networkextension/polar-projects/pulls) |
| [`polar-library`](https://github.com/networkextension/polar-library) | 2026-06-15 · [`6be1a51`](https://github.com/networkextension/polar-library/commit/6be1a51) refactor(firmware): cutover to assets-only (drop local-disk fallback + backfill) (#8) | [1 open](https://github.com/networkextension/polar-library/pulls) |
| [`polar-video`](https://github.com/networkextension/polar-video) | 2026-06-15 · [`495824c`](https://github.com/networkextension/polar-video/commit/495824c) Merge pull request #11 from networkextension/feat/video-assets-cutover | [1 open](https://github.com/networkextension/polar-video/pulls) |
| [`polar-expense`](https://github.com/networkextension/polar-expense) | 2026-06-15 · [`65d6f63`](https://github.com/networkextension/polar-expense/commit/65d6f63) refactor(receipts): cutover to assets-only (drop local-disk fallback + backfill) (#8) | [1 open](https://github.com/networkextension/polar-expense/pulls) |
| [`polar-latch`](https://github.com/networkextension/polar-latch) | 2026-06-02 · [`0e5ee53`](https://github.com/networkextension/polar-latch/commit/0e5ee53) fix(auth): scope to caller active workspace (#6) | [1 open](https://github.com/networkextension/polar-latch/pulls) |
| [`polar-music`](https://github.com/networkextension/polar-music) | 2026-08-20 · [`3e67f63`](https://github.com/networkextension/polar-music/commit/3e67f63) fix(ui): 播放器三处 UI 修复 — 心形图标 / 播放暂停切换 / 跳动条 (#15) | 0 |
...
| [`polar-wg-app`](https://github.com/networkextension/polar-wg-app) | 2026-08-29 · [`981a3cb`](https://github.com/networkextension/polar-wg-app/commit/981a3cb) Merge pull request #41 from networkextension/fix/scripts-no-python | 0 |
