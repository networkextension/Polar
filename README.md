...
_Last refreshed: 2026-06-02 23:07 UTC_

| Repo | Last commit | Open PRs |
|---|---|---|
| [`polar-sdk`](https://github.com/networkextension/polar-sdk) | 2026-06-02 · [`75fb0e8`](https://github.com/networkextension/polar-sdk/commit/75fb0e8) feat: AgentRegisterResponse carries per-agent proxy token (v0.9.0) | 0 |
...
| [`polar-agent`](https://github.com/networkextension/polar-agent) | 2026-06-02 · [`e399618`](https://github.com/networkextension/polar-agent/commit/e399618) Merge pull request #17 from networkextension/feat/task-pull-claim | 0 |
| [`polar-wg`](https://github.com/networkextension/polar-wg) | 2026-06-02 · [`4db4d52`](https://github.com/networkextension/polar-wg/commit/4db4d52) Merge pull request #13 from networkextension/fix/active-workspace | 0 |
...
| [`polar-hosts`](https://github.com/networkextension/polar-hosts) | 2026-06-02 · [`746b053`](https://github.com/networkextension/polar-hosts/commit/746b053) Merge pull request #23 from networkextension/feat/per-agent-proxy-token | 0 |
| [`polar-library`](https://github.com/networkextension/polar-library) | 2026-06-02 · [`c002f57`](https://github.com/networkextension/polar-library/commit/c002f57) fix(auth): scope to caller active workspace (#6) | 0 |
| [`polar-video`](https://github.com/networkextension/polar-video) | 2026-06-02 · [`a523907`](https://github.com/networkextension/polar-video/commit/a523907) Merge pull request #9 from networkextension/fix/active-workspace | 0 |
| [`polar-expense`](https://github.com/networkextension/polar-expense) | 2026-06-02 · [`08cd14d`](https://github.com/networkextension/polar-expense/commit/08cd14d) fix(auth): scope to caller active workspace (#6) | 0 |
